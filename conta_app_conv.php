...
if(isset($_POST['codconvenio'])) {
    $codconvenio = intval($_POST['codconvenio']);
}else{
    $codconvenio = null;
}
if(isset($_POST['mes'])) {
    ...
    $stmt = $pdo->prepare("SELECT associado.codigo AS associado,associado.nome, 
    ...
    $stmt->bindParam(':codconvenio', $codconvenio, PDO::PARAM_INT);
