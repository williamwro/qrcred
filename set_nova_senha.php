        ...
        if($novasenha == $confirmanovasenha){
            ...
            foreach ($result as $row) {
                ...
                if ($chave == $chavecorreta) {
                    ...
                    header("Location: https://qrcred.makecard.com.br/email_msg_sucesso.html");
                } else {
                    echo 'Erro: Este link já expirou.';
                }
            }
        }else{
            echo '(Confirma nova senha) não está igual a (Nova senha), corriga.';
        }
    } else {
        echo 'Informar a nova senha.';
    }
}else{
