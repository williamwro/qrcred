$(document).ready(function() {
    ...
    //if(divisao === "1"){//QrCred
        ...
        $("#img_empresa").attr("src", "../pictures_site-sind/image5.png").width('500px').height('390px'); 
        $('#rotulo_divisao_makecard').html("Sistema administrativo do cartão convenio SasCred");
